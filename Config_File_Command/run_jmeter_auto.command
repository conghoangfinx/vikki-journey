...
./jmeter.sh -n -t /Users/conghoang/Desktop/vikki-journey/Data_Support/10-vile-qa/vikki-journey-vile-qa-single-thread.jmx -l "$RESULTS_FOLDER/results.jtl" -e -o "$REPORT_FOLDER" -j "$LOGS_FOLDER/jmeter.log" &
