...
cd /Users/annguyen/apache-jmeter-5.6.3-backup/bin

# Kiểm tra và cấp quyền cho jmeter.sh
chmod +x jmeter.sh

# Tạo thư mục báo cáo vào Desktop và xóa thư mục báo cáo nếu có
REPORT_FOLDER="/Users/annguyen/Desktop/report_folder"
LOGS_FOLDER="/Users/annguyen/Desktop/logs"
RESULTS_FOLDER="/Users/annguyen/Desktop/results"
...
./jmeter.sh -n -t /Users/annguyen/Desktop/vikki-journey/Test_Whitelist_Auto_Unlink/vikki-journey-annguyen-qa-test-whitelist.jmx -l "$RESULTS_FOLDER/results.jtl" -e -o "$REPORT_FOLDER" -j "$LOGS_FOLDER/jmeter.log" &
